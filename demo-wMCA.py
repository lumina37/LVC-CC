...
task2 = Png2yuvTask(frames=1, parent_=task1)
task3 = CodecTask(vtm_type='AI', frames=1, QP=46, parent_=task2)
task4 = Yuv2pngTask(parent_=task3)
task5 = PostprocTask(parent_=task4)
task6 = RenderTask(frames=1, parent_=task5)
